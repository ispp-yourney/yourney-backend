...
class ImageControllerTests {
	...
	void setup() {
		...
		// ROLES
		Role ro1 = new Role(1l, RoleType.ROLE_USER);
		Role ro2 = new Role(2l, RoleType.ROLE_ADMIN);
...
void testNoUserDeleteForUser() throws Exception {
	...
	void testAdminUploadForItinerary() throws Exception {
