...
INSERT INTO landmarks(name, description, price, country, city, latitude, longitude, end_promotion_date, email, instagram, phone, twitter, website, category, views, image_id, create_date) VALUES
    ...
    21.75, 'Estados Unidos', 'Los Ángeles', 34.1022362941919, -118.34090682908928, '2031-02-02 18:17:25', 'info@chinesetheatres.com', NULL, '+1 3234645145', NULL, 'http://www.tclchinesetheatres.com/', 'Cine', 43, 11, '2021-01-01 00:00:01'),
    ('Chinatown',																		-- 2
    ...
    0.0, 'Estados Unidos', 'Los Ángeles', 34.009374925024446, -118.49722783651956, NULL, NULL, 'https://www.instagram.com/santamonicapier/', '+1 3104588900', 'https://twitter.com/santamonicapier', 'https://www.santamonicapier.org/', 'Punto turístico', 43, 13, '2021-01-01 00:00:01'),
    ('Playa de Venice',																	-- 4
    ...
    0.0, 'Estados Unidos', 'Los Ángeles', 34.05635960154746, -118.24878664627724, NULL, NULL, 'https://www.instagram.com/musiccenterla/', '+1 2139727211', 'https://twitter.com/musiccenterla', 'https://www.musiccenter.org/tmc-offstage/', 'Punto turístico', 43, 16, '2021-01-01 00:00:01'),
    ('Beverly Boulevard',																-- 7
    ...
    0.0, 'Cuba', 'La Habana', 23.14159406436587, -82.35674173105585, NULL, NULL, NULL, '+53 78601524', NULL, NULL, 'Museo', 56, 18, '2021-01-01 00:00:01'),
    ...
    0.0, 'Cuba', 'La Habana', 23.136963614390076, -82.35924480226626, NULL, NULL, NULL, '+53 78613077', NULL, 'https://www.entradas.com/city/la-habana-1637/venue/gran-teatro-alicia-alonso-22536/', 'Punto Turístico', 56, 19, '2021-01-01 00:00:01'),
    ...
    0.0, 'Cuba', 'La Habana', 23.13829183582773, -82.36849345549514, '2023-12-10 11:08:02', NULL, NULL, '+53 78644977', NULL, NULL, 'Restaurante', 56, 22, '2021-01-01 00:00:01'),
	-- Itinerary 3
	('Tokyo Skytree',																	-- 13
    ...
    ('Theresa Grill',                                                                   -- 21
    'Theresa Grill',
    0.0, 'Alemania', 'Munich', 48.14800046368059, 11.575535998374159, NULL, NULL, NULL, '+49 8928803301', NULL, 'http://www.theresa-restaurant.com/', 'Gastronomia', 53, 31, '2021-01-01 00:00:01'),
    ...
    4.0, 'Alemania', 'Munich', 48.154189129627916, 11.591678540703432, NULL, NULL, NULL, '+49 8928803301', NULL, 'http://www.rumfordschloessl.de/', 'Parque', 53, 32, '2021-01-01 00:00:01'),
    ('MISSHA Cosmetics GmbH',                                                           -- 23
    'MISSHA Cosmetics GmbH',
    0.0, 'Alemania', 'Munich', 48.78482405058518, 11.474290778438942, NULL, NULL, NULL, '+49 84113802844', NULL, 'https://kbeautyhouse.de/', 'Cosmetica', 53, 33, '2021-01-01 00:00:01'),
    ('Fendstüberl',                                                                     -- 24
    'Fendstüberl',
    0.0, 'Alemania', 'Munich', 48.15996731646397, 11.58679398303263, NULL, NULL, NULL, '+49 89397150', NULL, NULL, 'Bar/Copas', 53, 34, '2021-01-01 00:00:01'),
    ('Blue Nile One München',                                                           -- 25
    'Blue Nile One München',
    0.0, 'Alemania', 'Munich', 48.160700868082856, 11.588337198374543, '2023-03-03 10:10:20', NULL, NULL, '+49 89342389', NULL, 'https://blue-nile-one.de/', 'Restaurante', 53, 35, '2021-01-01 00:00:01'),
	-- Itinerary 5
	('Torre Eiffel',                                                           			-- 26
    'Emblemática torre de hierro forjado diseñada por Gustave Eiffel y construida en 1889, dispone de observatorio.',
    0.0, 'Francia', 'París', 48.86245165181368, 2.294873015425074, NULL, NULL, NULL, '+33892701239', NULL, 'https://www.toureiffel.paris/', 'Lugar de interés histórico', 33, 36, '2021-01-01 00:00:01'),
	('Museo del Louvre',                                                           		-- 27
    'Antiguo palacio con una gran colección de arte, desde esculturas romanas hasta "La Mona Lisa" de da Vinci.',
    0.0, 'Francia', 'París', 48.86203827021599, 2.3375541557348547, NULL, NULL, NULL, '+33140205050', NULL, 'https://www.louvre.fr/', 'Museo de arte', 33, 37, '2021-01-01 00:00:01'),
	('Catedral de Notre Dame',                                                          -- 28
    'Imponente catedral del siglo XIII con arbotantes y gárgolas y marco de la novela de Víctor Hugo.',
    0.0, 'Francia', 'París', 48.852993026337295, 2.3499133107394714, NULL, NULL, NULL, '+33142345610', NULL, 'https://www.notredamedeparis.fr/', 'Catedral', 33, 38, '2021-01-01 00:00:01'),
	('Arco de Triunfo de París',                                                        -- 29
    'Arco triunfal emblemático conmemorativo de las victorias de Napoleón, cuenta con observatorio.',
    0.0, 'Francia', 'París', 48.87480495771061, 2.295104424697544, NULL, NULL, NULL, '+33155377377', NULL, 'http://www.paris-arc-de-triomphe.fr/', 'Monumento', 33, 39, '2021-01-01 00:00:01'),
	('Panteón de París',                                                           		-- 30
    'Mausoleo del siglo  XVIII con fachada de columnas que contiene los restos de ciudadanos franceses ilustres.',
    0.0, 'Francia', 'París', 48.84657588873261, 2.346487317716868, NULL, NULL, NULL, '+33144321800', NULL, 'http://www.paris-pantheon.fr/', 'Monumento', 33, 40, '2021-01-01 00:00:01'),
	-- Itinerary 6
	('Santa Teresa',																	-- 31
    ...
    0.0, 'Reino Unido', 'Londres', 51.499632994848696, -0.12477701526214918, NULL, NULL, NULL, '+442072193000', NULL, 'https://www.parliament.uk/about/living-heritage/building/palace/', 'Oficina de Administración', 24, 46, '2021-01-01 00:00:01'),
    ...
    0.0, 'Reino Unido', 'Londres', 51.49941160016445, -0.1272959507319059, NULL, NULL, NULL, '+442072225152', NULL, 'https://www.westminster-abbey.org/', 'Iglesia', 24, 47, '2021-01-01 00:00:01'),
    ...
    0.0, 'Reino Unido', 'Londres', 51.50815912329038, -0.07597075944035449, NULL, NULL, NULL, '+442031666000', NULL, 'https://www.hrp.org.uk/tower-of-london/', 'Castillo', 24, 49, '2021-01-01 00:00:01'),
	('Puente de la Torre',																-- 40
    'Puente de la Torre', 
    0.0, 'Reino Unido', 'Londres', 51.50551648211462, -0.07534577293333111, NULL, NULL, NULL, '+442074033761', NULL, 'http://www.towerbridge.org.uk/', 'Puente', 24, 50, '2021-01-01 00:00:01'),
    ...
    0.0, 'Reino Unido', 'Londres', 51.51390537105028, -0.09832914409729898, NULL, NULL, NULL, '+442072468350', NULL, 'https://www.stpauls.co.uk/', 'Catedral', 24, 51, '2021-01-01 00:00:01'),
	('Ojo de Londres',																	-- 42
    'Enorme noria que permite disfrutar de vistas privilegiadas sobre los puntos de interés de la ciudad.', 
    0.0, 'Reino Unido', 'Londres', 51.50333067149294, -0.11955370176912707, NULL, NULL, NULL, '+442079678021', NULL, 'https://www.londoneye.com/', 'Atracción turística', 24, 52, '2021-01-01 00:00:01'),
	('Museo Británico',																	-- 43
    'Enorme despliegue de antigüedades mundiales, incluidas momias egipcias y esculturas de la antigua Grecia.', 
    0.0, 'Reino Unido', 'Londres', 51.52003207271771, -0.12672617010759582, NULL, NULL, NULL, '+442073238299', NULL, 'https://www.britishmuseum.org/', 'Museo', 24, 53, '2021-01-01 00:00:01'),
	('Hyde Park',																		-- 44
    'Gran extensión verde con un monumento a Diana de Gales y con el Serpentine, un lago para nadar o ir en barca.', 
    0.0, 'Reino Unido', 'Londres', 51.50740398633511, -0.1655908685627789, NULL, NULL, NULL, '+443000612000', NULL, 'https://www.royalparks.org.uk/parks/hyde-park', 'Edificio Multiusos', 24, 54, '2021-01-01 00:00:01'),
	-- Itinerary 8
    ...
    0.0, 'Italia', 'Roma', 41.90332033748617, 12.46580734147082, NULL, NULL, NULL, '+39 066819111', NULL, 'http://castelsantangelo.beniculturali.it/', 'Punto turístico', 72, 55, '2021-01-01 00:00:01'),
    ('Foro Romano',																		-- 46
    'Extensa área excavada de templos, plazas y edificios del gobierno romanos, algunos de 2000 años de antigüedad.',
    0.0, 'Italia', 'Roma', 41.893300149654884, 12.485914413956753, NULL, NULL, 'https://www.instagram.com/parcocolosseo/', '+39 0669984452', 'https://twitter.com/parcocolosseo', 'https://parcocolosseo.it/area/foro-romano/', 'Monumento', 72, 56, '2021-01-01 00:00:01'),
    ('Restaurante Bar del Fico',														-- 47
    'Restaurante situado en el centro de Roma.', 
    0.0, 'Italia', 'Roma', 41.899514655861495, 12.470745472346334, '2023-02-02 18:17:25', NULL, NULL, '+39 0688657702', NULL, 'https://www.quandoo.it/place/ristorante-bar-del-fico-58507?aid=63', 'Restaurante', 72, 57, '2021-01-01 00:00:01'),
    ...
    0.0, 'Italia', 'Roma', 41.90238730055132, 12.4540704788047, NULL, NULL, NULL, '+39 066982', NULL, 'http://www.vatican.va/various/basiliche/san_pietro/index_it.htm', 'Punto turístico', 72, 58, '2021-01-01 00:00:01'),
    ('Coliseo Romano',																	-- 49
    'Monumental anfiteatro romano de 3 niveles que acogió luchas de gladiadores, que ofrece visitas guiadas.', 
    0.0, 'Italia', 'Roma', 41.89054823933745, 12.492517345431995, NULL, NULL, NULL, '+39 0639967700', NULL, 'https://parcocolosseo.it/', 'Monumento', 72, 59, '2021-01-01 00:00:01'),
    ('Fontana Di Trevi',																-- 50
    'Fuente rococó de 1762 con figuras esculpidas diseñada por Nicola Salvi y abastecida por un acueducto.', 
    0.0, 'Italia', 'Roma', 41.901101826560506, 12.482979375606169, NULL, NULL, NULL, '+39 060608', NULL, 'https://www.turismoroma.it/it/node/1286', 'Monumento', 72, 60, '2021-01-01 00:00:01'),
	-- Itinerary 9
	('Suomenlinna',																		-- 51
    ...
    0.0, 'Finlandia', 'Helsinki', 60.21189661021851, 24.8774767430376, NULL, NULL, 'https://www.instagram.com/seikkailupuistozippy/', '+358 60093456', NULL, 'https://www.zippy.fi/', 'Parque', 51, 63, '2021-01-01 00:00:01'),
