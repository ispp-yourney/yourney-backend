...
INSERT INTO itineraries(name, description, status, recommended_season, budget, estimated_days, create_date, views, author_id, image_id) VALUES
    ...
    'PUBLISHED', 'SUMMER', 135.0, 5, '2021-03-26 10:14:17', 56, 3, 2),											       											-- 2
    ('Viaje a Tokio',
    ...
    'PUBLISHED', 'ANYTIME', 109.0, 5, '2021-04-10 17:52:10', 53, 5, 4),  												   	    									-- 4
    ('Enamorate de París',
    ...
    'PUBLISHED', 'ANYTIME', 60.0, 5, '2021-04-12 14:48:45', 33, 2, 5), 										          											-- 5
    ...
    'PUBLISHED', 'WINTER', 80.0, 9, '2021-02-18 16:19:23', 51, 2, 9),      										     										-- 9
