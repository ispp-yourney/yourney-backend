...
public interface ItineraryRepository extends JpaRepository<Itinerary, Long> {
    ...
    Page<ItineraryProjection> findAllItineraryProjectionsOrdered(Pageable pageable);
    ...
    Page<ItineraryProjection> findSearchItineraryProjectionsOrdered(Pageable pageable, String cadena);
    ...
    Page<ItineraryProjection> findUserItineraryProjectionsOrdered(Pageable pageable, Long userId);
